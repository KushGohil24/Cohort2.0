...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Let ProtectedRoute handle redirect naturally
    } catch (err) {
      ...
      <main className="relative z-10 w-full max-w-md px-6 py-12">
        <div className="bg-surface-container-low/70 backdrop-blur-xl p-8 rounded-xl shadow-2xl shadow-surface-container-lowest border border-outline-variant/10">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="font-headline text-3xl font-extrabold tracking-tighter text-on-surface mb-1">Second Brain</h1>
            <p className="text-on-surface-variant font-medium tracking-tight text-sm">Cognitive Sanctuary</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <a className="text-xs font-bold text-primary hover:text-primary-fixed-dim transition-colors" href="#">Forgot?</a>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          <div className="mt-8 pt-8 border-t border-outline-variant/10 text-center">
            <p className="text-on-surface-variant text-sm">
              ...
              <Link to="/register" className="text-primary font-bold hover:underline underline-offset-4 decoration-primary/30 transition-all ml-1">Register</Link>
            </p>
          </div>
        </div>
      </main>
